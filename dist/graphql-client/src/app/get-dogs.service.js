...
var GetDogsService = /** @class */ (function () {
    function GetDogsService(apollo) {
        ...
        this.dogsQuery = this.apollo.watchQuery({
            query: (0, apollo_angular_1.gql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["query getDogs($offset: Int!){\n        getDogs($offset: Int!){\n          count\n          allDogs{\n            name,\n            breed_primary,\n            contact_state\n          }\n        }\n      }\n    }"], ["query getDogs($offset: Int!){\n        getDogs($offset: Int!){\n          count\n          allDogs{\n            name,\n            breed_primary,\n            contact_state\n          }\n        }\n      }\n    }"])))
        });
        this.findDogQuery = this.apollo.watchQuery({
            query: (0, apollo_angular_1.gql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["query dog($name: String!) {\n        dog(name: $name) {\n          name\n          breed_primary\n        }\n      }"], ["query dog($name: String!) {\n        dog(name: $name) {\n          name\n          breed_primary\n        }\n      }"])))
        });
    }
